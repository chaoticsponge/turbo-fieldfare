# Upstream Gemma runtime reference

This is the documentation before the Qwen Mac-app conversion. The Gemma library, CLI, server, and repacker remain available; references below to the Mac app describe the upstream Gemma version. See [the current README](../README.md) for the Qwen app.
...
| Community Reports | [Here](COMMUNITY_BENCHMARKS.md#community-results) |
...
See [community benchmark results](COMMUNITY_BENCHMARKS.md#community-results)
from other Macs, or follow the
[community benchmark guide](COMMUNITY_BENCHMARKS.md) to add your own.
...
[System design](SYSTEM_DESIGN.md#images) covers how the tower runs and
